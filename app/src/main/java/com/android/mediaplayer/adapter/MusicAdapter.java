...
public class MusicAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //赋值 准确的是绑定赋值的中介
        viewHolder.titleTv.setText(musicList.get(position).getTitle());
        viewHolder.artistTv.setText(musicList.get(position).getArtist() + "-" + musicList.get(position).getAlbum());
        viewHolder.albumImgv.setImageBitmap(musicList.get(position).getAlbumBip());
